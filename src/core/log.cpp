...
extern "C" {
#endif /*__cplusplus*/
void logV(const char* fmt, ...) PUBLIC_SYMBOL;
void logD(const char* fmt, ...) PUBLIC_SYMBOL;
void logI(const char* fmt, ...) PUBLIC_SYMBOL;
void logW(const char* fmt, ...) PUBLIC_SYMBOL;
void logE(const char* fmt, ...) PUBLIC_SYMBOL;
void logF(const char* fmt, ...) PUBLIC_SYMBOL;
extern void (*logVolcano)(char level, const char* fmt,
                          va_list ap) PUBLIC_SYMBOL;
#ifdef __cplusplus
}
#endif /*__cplusplus*/
#endif
