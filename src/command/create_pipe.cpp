...
PipelineCreateInfo::PipelineCreateInfo(RenderPass& pass) {
  ...
  rastersci.sType = autoSType(rastersci);
  ...
  multisci.sType = autoSType(multisci);
  ...
  depthsci.sType = autoSType(depthsci);
  ...
  subpassDesc.sType = autoSType(subpassDesc);
